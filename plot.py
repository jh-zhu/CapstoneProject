...
class summary_plots(object):
    ...
    def plot_weight(self, redis, sigma, coefficients, N, stage):
        ...
        if self.learner_name == "EWA":
            learner = exponential_weighted_average(self.models,0.05,redis=redis)
...
sigmas=np.arange(0,3,1)
N=3000

summary_plots = summary_plots("FTL")
summary_plots.plot_weight(redis=0, sigma=0, coefficients = [0.3,0.4], N=N, stage=1)
